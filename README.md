...
| other-gcc32-url | false | Please fill in the download link of other gcc32 in this option. Supports .xz, .zip, .tar, .tar.xz and .git formats | https://github.com/username/gcc |
